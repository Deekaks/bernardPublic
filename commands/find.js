...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("find")
    .setDescription("Retrieve data from API based on user ID")
  ...
  async execute(interaction) {
    try {
      ...
      const targetGroupIds = [
        4606577, 5894237, 4606666, 4606663, 9925701, 4609731, 6868503, 6868508,
        5920541, 11397930, 11399363, 11397462, 4609692, 4609343,
      ];
